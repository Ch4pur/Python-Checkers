import pygame
from .constants import BLACK, ROWS, WHITE, SQUARE_SIZE, COLS, WHITE
...
class Board:
    def __init__(self):
        self.board = []
        self.black_left, self.white_left = 12, 12
        self.black_kings, self.white_kings = 0, 0
        self.create_board()
    ...
    def move(self, checker, row, col):
        self.board[checker.row][checker.col], self.board[row][col] = self.board[row][col], self.board[checker.row][
            checker.col]
